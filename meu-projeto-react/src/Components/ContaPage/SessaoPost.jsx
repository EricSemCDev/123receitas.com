    ...
    return (
     <section className="p-5 border-1 border-[#c9c9c9] shadow-lg flex flex-col space-y-4">
        <div className="flex justify-between items-center">
            ...
            <button className="cursor-pointer px-2 space-x-1 w-70 h-12 mt-2 rounded-xl flex justify-center items-center bg-[#FF7B00] hover:bg-[#FF3700] transition-all duration-300 ease-in-out transform hover:scale-98">
